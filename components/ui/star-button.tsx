...
export function StarButton({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 dark:border-white/15 border-[var(--gold)]/20 z-[4] overflow-hidden rounded-[inherit] dark:text-black text-[var(--gold)]"
        style={{ borderWidth: "var(--border-width)" }}
        aria-hidden="true"
      >
        <StarBackground color={backgroundColor} />
      </div>
      <span className="z-10 relative bg-gradient-to-t dark:from-white dark:to-neutral-500 from-white to-gray-400 inline-block text-transparent bg-clip-text">
        {children}
      </span>
    </button>
  );
